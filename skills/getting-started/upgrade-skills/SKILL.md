...
Agent file edited (which) · block sub-blocks written · `later` row and label added or n/a · idea notes section and label added or n/a · worktree text removed · skills linked (listed) · repo-own skills left (listed) · harness replaced, kept, or none · guard removed or n/a · verify result.

...
Agent file edited (which) · block sub-blocks written · worktree text removed · skills linked (listed) · repo-own skills left (listed) · harness replaced, kept, or none · guard removed or n/a · verify result.
